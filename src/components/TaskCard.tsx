...
import { Check, ArrowRight, Forward, Trash2, CalendarDays, Timer, AlertCircle, Tag } from 'lucide-react';
      ...
      <CardContent className="p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex-1 space-y-2">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Badge variant="outline" className="text-[9px] uppercase tracking-tighter border-white/10 font-bold bg-white/5 text-muted-foreground flex items-center gap-1 h-5">
              <Tag size={10} />
